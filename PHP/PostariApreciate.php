<?php
	...
	while($row = $info->fetch_assoc()) {
		...
		<tr> <td></td>  <td><input type="hidden" name="tip" value="'.'2'.'"/></td></tr>
		...
		<table>
		<tr> <td></td>  <td><input type="hidden" name="id" value="'.$row['Numar'].'"/></td></tr>
		<tr> <td></td>  <td><input type="hidden" name="tip1" value="'.'2'.'"/></td></tr>
		...
		<tr> <td></td>  <td><input type="hidden" name="tip2" value="'.'2'.'"/></td></tr>
		...
		<tr> <td></td>  <td><input type="hidden" name="tip3" value="'.'2'.'"/></td></tr>
